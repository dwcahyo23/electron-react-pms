...
import { faLeaf, faSignOut, faMagnifyingGlass, faTimes } from '@fortawesome/free-solid-svg-icons'
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import initMenu from '../data/menus'
          ...
          <ul className="">
            {menus.map((menu, index) => (
              <li key={index} className="gap-6">
                ...
                >
                  <FontAwesomeIcon icon={menu.icon} className="w-6"></FontAwesomeIcon> {menu.name}
                </Link>
              </li>
            ))}
          </ul>
