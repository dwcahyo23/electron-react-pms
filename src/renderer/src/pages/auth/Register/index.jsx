...
function RegisterIndex() {
  ...
  const registerImage = 'https://edp.raincode.my.id/static/media/login.cc0578413db10119a7ff.png'
  return (
    <>
        ...
        <div className="flex w-full flex-col md:flex-row">
          ...
          <div className="md:bg-emerald-500 md:min-h-screen flex flex-wrap md:w-1/2">
            <div className="items-center text-center flex flex-col relative justify-center mx-auto">
              <img src={registerImage} alt="Logo" className="md:w-72 w-48 mx-auto" />
              <div className="md:block hidden text-slate-100">
                <h1 className="font-semibold text-2xl pb-2">Register an Account</h1>
                <span className="text-sm">Free access to EDP Online services</span>
              </div>
            </div>
          </div>
          {/* Register Section */}
